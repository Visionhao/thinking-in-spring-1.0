package com.vincent.mvcframework.v2.servlet;
...
public class VincentDispatcherServletV2 extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("Vincent Spring framwork is init.");
    }
        ...
        try {
            for(String className : classNames){
                ...
                if(clazz.isAnnotationPresent(VincentController.class)){
                    ...
                    //自定义命名
                    String beanName = clazz.getAnnotation(VincentService.class).value();
                    ...
                    //3、如果是接口，判断有多少个实现类，如果只有一个，默认就选择这个实现类，如果有多个，只能抛异常了
